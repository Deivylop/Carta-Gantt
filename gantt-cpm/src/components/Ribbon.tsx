            ...
            <div className="ribbon-body">
                ...
                {tab === 'vista' && <>
                    ...
                    <RG label="MOSTRAR">
                        ...
                        <RB icon={<PanelBottomClose size={14} />} label="Info Tarea" active={state.showDetailPanel} onClick={() => dispatch({ type: 'TOGGLE_DETAIL_PANEL' })} title="Mostrar/Ocultar panel de detalle de tarea" />
                    </RG>
                    <RG label="FILTROS">
